...
class MyTypeScreen extends State<TypeScreen> {
  Sqldb sqldb = Sqldb();
...
//           ),
        ...
        body: FutureBuilder<List<Map<String, dynamic>>>(
            future: Sqldb().readData("SELECT * FROM  'AidType'"),
        ...
        return Directionality(
            ...
            child: AlertDialog(
              ...
              actions: <Widget>[
                ...
                TextButton(
                  onPressed: () async {
                    await sqldb.updateUserAndRelatedOrders(
                        a, controller.text, a1);

                    ///امر غريب
                    //   sqldb.updateItem(a1! , aidType: _controller.text);
                    // await sqldb.updateData('''
                    //  UPDATE AidType SET aidtype = "${_controller.text}" WHERE id = ${a}
