...
class Myshowbwteendatefundmony extends StatefulWidget {
  ...
  const Myshowbwteendatefundmony(
      {super.key,
...
class Myshow extends State<Myshowbwteendatefundmony> {
  Timer? _timer;
  ...
  void initState() {
    super.initState();
    _eventsFuture = sqldb.getEventsByCategory(
