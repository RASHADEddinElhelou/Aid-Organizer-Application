...
class Items extends StatefulWidget {
  ...
  const Items({super.key, required this.receivedText});

  @override
  State<StatefulWidget> createState() => MyItems();
}

class MyItems extends State<Items> {
  Timer? _timer;
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Align(
            ...
            child: Text(widget.receivedText,
        ...
        body: FutureBuilder<List<Map<String, dynamic>>>(
          future: Sqldb().queryItems(widget.receivedText),
